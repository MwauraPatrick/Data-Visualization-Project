...
const Inventory = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let chart;
  return `<div class="container"><div class="inputs" data-svelte-h="svelte-1b8js6e"><label for="myDate">Select Month and Year:</label> <input type="month" id="myDate"></div> <canvas id="Inventory" width="400" height="400"${add_attribute("this", chart, 0)}></canvas></div>`;
});
const css = {
