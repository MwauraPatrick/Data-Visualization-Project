...
<div class="text-column">
	<p>
		...
		electrical needs. By leveraging collected data, we aim to monitor the supply
		chain and gain insights for developing effective strategies for enhancing
		efficiency.
	</p>
	<pre>Key Features</pre>
	<ul>1. Vendor Information</ul>
	<p>
	...
	<ul>2. Production Plant Activities</ul>
	<p>
	...
	<ul>
		<li>How can we increase efficiency?</li>
		<li>How can we increase efficiency?</li>
		<li>Are there production bottlenecks?</li>
		<li>Can we optimise transportation routes?</li>
		<li>How do we make insights detectable through a dashboard?</li>
		<li>What metrics should be displayed?</li>
		<li>How can we ensure actionable insights?</li>
		<li>How can this information drive decision-making?</li>
		<li>Can we reduce lead times?</li>
		<li>Should we adjust production schedules based on demand fluctuations?</li>
	</ul>
